...
<head>
    ...
    <title>Create Account | OTT STORE PREMIUM</title>
...
<div class="auth-card">
    <div class="text-center mb-4">
        ...
        <p class="text-secondary small mb-0">Join OTT Store for faster orders and order tracking</p>
    </div>
    ...
    <form method="POST">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="username" placeholder="John Doe" value="<?= htmlspecialchars($_POST['username'] ?? '') ?>" required>
        </div>
        ...
        <div class="form-check mb-4">
            ...
            <label class="form-check-label text-secondary small" for="terms">
                I agree to the <a href="terms-and-conditions.html" class="text-indigo-400 text-decoration-none" style="color: #818cf8;">Terms & Conditions</a>
            </label>
        </div>
        ...
        <div class="text-center">
            <small class="text-secondary">Already have an account? <a href="login.php" style="color: #a5b4fc; font-weight: 600;" class="text-decoration-none">Login here</a></small>
        </div>
